                                    ...
                                    <div class="col-lg-8 col-md-offset-2">
                                        ...
                                        <table class="table table-bordered table-hover table-striped" align="center">
                                            <tr>
                                                ...
                                                <td><strong><?php echo  $count = $db->countOfAll($con,"stock_avail");?>&nbsp;</strong></td>
                                                <td>Payment Pending:</td>
                                                <td><strong><?php echo $db->queryUniqueValue($con,"select sum(balance) FROM  stock_entries where count1=1 and type='entry'"); ?></strong></td>
                                            </tr>
                                            <tr>
                                                <td>Tatal Sales:</td>
                                                <td><strong><?php echo  $age = $db->queryUniqueValue($con,"SELECT sum(subtotal) FROM stock_sales where count1=1 ");?></strong></td>
                                                <td>Outstanding Amount: </td>
                                                <td><strong><?php echo $db->queryUniqueValue($con,"select sum(balance) FROM  stock_sales where count1=1"); ?></strong></td>

                                            </tr>

                                            <tr>
                                                <td>Total number of Suppliers </td>
                                                <td><strong><?php echo $count = $db->countOfAll($con,"supplier_details");?></strong></td>
                                                <td>Total Number of Customers </td>
                                                <td><strong><?php echo $count = $db->countOfAll($con,"customer_details");?></strong></td>
