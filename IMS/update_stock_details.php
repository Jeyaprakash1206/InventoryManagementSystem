                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        if(isset($_POST['stock_name'])) {
                            ...
                            $sid = mysqli_real_escape_string($con,$_POST['stock_id']);
                            $name = mysqli_real_escape_string($con,$_POST['stock_name']);
                            $category = mysqli_real_escape_string($con,$_POST['category']);
                            $buyingrate = mysqli_real_escape_string($con,$_POST['company_price']);
                            $sellingrate = mysqli_real_escape_string($con,$_POST['selling_price']);
                            $suplier = mysqli_real_escape_string($con,$_POST['supplier_id']);
                            $uom = mysqli_real_escape_string($con,$_POST['uom']);
                       //    $expiry = mysqli_real_escape_string($con,$_POST['expire_date']);
                            ...
                            $db->execute($con,"UPDATE stock_details SET stock_id='$sid',stock_name='$name',supplier_id='$suplier',company_price=$buyingrate,
