                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-offset-3">
                                        ...
                                        if(isset($_POST['id']))
                                        {
                                            ...
                                            $db->query($con,"UPDATE supplier_details  SET supplier_name='$name',supplier_address='$address',supplier_contact1='$contact1',supplier_contact2='$contact2' where id=$id");
                                        ...
                                        if(isset($_GET['sid']))
                                            $id=$_GET['sid'];
                                        $line = $db->queryUniqueObject($con,"SELECT * FROM supplier_details WHERE id=$id");
