                        ...
                        <div class="col-lg-12">
                            <div class="panel-body">
                                ...
                                <form class="navbar-form navbar-left" action="" method="get" name="page">
                                    Limit<input class="form-control" name="limit" type="text"  style="margin-left:5px;" value="<?php if(isset($_GET['limit'])) echo $_GET['limit']; else echo "20"; ?>" size="3" maxlength="3">
                                        ...
                                        <form role="form" name="deletefiles" action="deleteselected.php" method="post" >
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped">
                                                    ...
                                                    $line = $db->queryUniqueObject($con,"SELECT * FROM stock_sales WHERE transactionid='$transid' ");
                                                    $mysqldate=$line->date;
