	...
	<table width="595"  cellspacing="0" cellpadding="0" id="bordertable"  border="1">
        ...
        <td align="center"><strong>Sales Receipt <br />
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  $sid=$_GET['sid'];
			$line = $db->queryUniqueObject($con,"SELECT * FROM stock_sales WHERE transactionid='$sid' ");
			$mysqldate=$line->date;
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <?php 
				...
				$line2 = $db->queryUniqueObject($con,"SELECT * FROM customer_details WHERE customer_name='$cname'  " );
				?>
				<br />
				<?php
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <?php
		  $i=1;
		 $db->query($con,"SELECT * FROM stock_sales where transactionid='$sid'");
