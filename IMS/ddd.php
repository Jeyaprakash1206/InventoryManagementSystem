                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    if(isset($_POST['name']))
                                    {
                                        ...
                                        $j=1;
                                        $username = $_SESSION['username'];
                                        $max = $db->maxOfAll($con,"id", "stock_details");
                                        $max=$max+1;
                                        $autoid="SD".$max."";
                                        $max1 = $db->maxOfAll($con,"id", "stock_entries");
                                        $max1=$max1+1;
                                        $autoid1="SE".$max1."";
