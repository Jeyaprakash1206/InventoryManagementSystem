                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                if(isset($_POST['name']))
                                {
                                    ...
                                    $suplier=mysqli_real_escape_string($con,$_POST['supplier']);
                                    $selected_date=$_POST['expire_date'];
                                    $selected_date=strtotime( $selected_date );
                                    $mysqldate = date( 'Y-m-d', $selected_date );
                                    $expire_date=$mysqldate;
                                    $count = $db->countOf($con,"stock_details", "stock_id='$id'");
                                    if($count==1)
                                    {
                                    ...
                                    {
                                        if($db->query($con,"insert into stock_details(stock_id,stock_name,stock_quatity,supplier_id,company_price,selling_price,category,expire_date)
                                              values('$id','$name',0,'$suplier',$buyingrate,$sellingrate,'$category','$expire_date')"))
                                        {
                                            ...
                                            $db->query($con,"insert into stock_avail(name,quantity) values('$name',0)");
                                        }
                                        else
