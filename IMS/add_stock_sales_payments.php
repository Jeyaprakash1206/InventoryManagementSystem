                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    if(isset($_POST['id']))
                                    {
                                        ...
                                        $max = $db->maxOfAll($con,"id", "transactions");
                                        $receiptid="RCPT".$max;
                                        if($db->query($con,"UPDATE stock_sales SET balance=$balance,payment=$payment,due='$due' where transactionid='$id'"))
                                        {
                                            $db->query($con,"INSERT INTO transactions (type,customer,subtotal,payment,balance,due,rid)
