                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $count = $db->countOfAll($con,"stock_avail"); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Tatal Sales Transactions</td>
                                            <td><?php echo  $count = $db->countOfAll($con,"stock_sales");?></td>
                                        </tr>
                                        <tr>
                                            <td>Total number of Suppliers</td>
                                            <td><?php echo $count = $db->countOfAll($con,"supplier_details");?></td>

                                        </tr>
                                        <tr>
                                            <td>Total Number of Customers</td>
                                            <td><?php echo $count = $db->countOfAll($con,"customer_details");?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
