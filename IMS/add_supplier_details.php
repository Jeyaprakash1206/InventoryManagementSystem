                            ...
                            <div class="panel-body">
                                <div class="row">
...

                                    {
                                        ...
                                        $count = $db->countOf($con,"customer_details", "customer_name='$name'");
                                        if($count==1)
                                        {
                                        ...
                                        else
                                        {
                                            ...
                                            if($db->query($con,"insert into supplier_details values(NULL,'$name','$address','$contact1','$contact2',0)"))
                                        ...
                                        <form role="form" name="form1" method="post" id="form1" action="" align="center">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="name" type="text" id="name"  class="validate[required,length[0,100]] text-input" 
                                                    required aria-required="true" pattern="[A-Za-z]+\[A-Za-z]+" autocomplete="off">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="contact1" type="text" id="buyingrate"  
                                                class="validate[optional,custom[onlyNumber],length[6,15]] text-input" required 
                                                aria-required="true" pattern="[+0-9]+" autocomplete="off">
                                            </div>

                                            <div class="form-group">
                                                <label>Contact2</label>
                                                <input class="form-control" name="contact2" type="text" id="sellingrate"  
                                                class="validate[optional,custom[onlyNumber],length[6,15]] text-input"  required 
                                                aria-required="true" pattern="[+0-9]+" autocomplete="off">
                                            </div>
