...
<?php
		...
		echo "<font color=red> Dublicat Entry. Please Verify</font>";
			...
			if($db->query($con,"insert into stock_details(stock_id,stock_name,stock_quatity,supplier_id,company_price,selling_price,category,expire_date,uom) values('$id','$name',0,'$suplier',$buyingrate,$sellingrate,'$category','$expiry','$uom')"))
