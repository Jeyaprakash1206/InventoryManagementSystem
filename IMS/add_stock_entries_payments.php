                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    if(isset($_POST['id']))
                                    {
                                        ...
                                        $newpayment=mysqli_real_escape_string($con,$_POST['newpayment']);
                                        ...
                                        if($db->query($con,"UPDATE stock_entries  SET balance=$balance,payment=$payment,due='$due' where stock_id='$id'"))
                                        {
                                            $db->query($con,"INSERT INTO transactions(type,supplier,payment,balance,rid,due,subtotal) values('entry','$supplier',$newpayment,$balance,'$id','$due',$subtotal)");
                                    ...
                                    <div class="col-lg-6 col-md-offset-3">
                                        <form role="form" name="form1" method="post" id="form1" action="" align="center">
                                          ...
                                          <a href="view_stock_entries_payments.php"><input type="button" name="Reset" value="Cancel" class="btn btn-primary"></a>
                                        </form>
                                    </div>
                                </div>
                            </div>
