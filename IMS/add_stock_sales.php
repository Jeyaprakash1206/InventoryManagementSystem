                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    if(isset($_POST['billnumber']))
                                    {
                                        ...
                                        $temp_balance = $db->queryUniqueValue($con,"SELECT balance FROM customer_details WHERE customer_name='$customer'");
